...
namespace BodyReport.Droid.Framework
{
    ...
    {
        public override void ResizeImage(string imagePath, string resizeImagePath, int maxSize)
        {
            ...
            Bitmap scaledBitmap = Bitmap.CreateBitmap(srcBitmap, 0, 0,
            ...
            using (Stream fileStream = File.OpenWrite(resizeImagePath))
            {
